...
class PartiesControllerTest < ActionController::TestCase
  ...
  test "should create party" do
    assert_difference('Party.count') do
      post :create, party: { address: @party.address, county_id: @party.county_id, municipality_id: @party.municipality_id, name: @party.name, state_id: @party.state_id }
    end
  ...
  test "should update party" do
    patch :update, id: @party, party: { address: @party.address, county_id: @party.county_id, municipality_id: @party.municipality_id, name: @party.name, state_id: @party.state_id }
    assert_redirected_to party_path(assigns(:party))
  end
